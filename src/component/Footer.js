...
function Footer() {
  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="flex justify-center text-teal-600">
         <h1 className='text-2xl text-navy-700'>Amana Consultancy</h1>
    </div>
    ...
    <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
      ...
      <li>
        <Link to="/services" className="text-gray-700 transition hover:text-gray-700/75" > Services </Link>
      </li>

      <li>
        <Link to="/faqs" className="text-gray-700 transition hover:text-gray-700/75" > Faq </Link>
      </li>
